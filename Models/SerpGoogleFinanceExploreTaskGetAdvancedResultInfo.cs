...
namespace DataForSeo.Client.Models
{
    ...
    public class SerpGoogleFinanceExploreTaskGetAdvancedResultInfo 
    {
        ...
        /// <br/>possible item types: <see href="#google_finance_hero_groups">google_finance_hero_groups</see>, <see href="#google_finance_interested">google_finance_interested</see>, <see href="#google_finance_interested">google_finance_news</see>, <see href="#google_finance_earnings_calendar">google_finance_earnings_calendar</see>, <see href="#google_finance_most_followed">google_finance_most_followed</see>, <see href="#google_finance_market_trends">google_finance_market_trends</see>, <see href="#google_finance_people_also_search">google_finance_people_also_search</see>
        /// </summary>
