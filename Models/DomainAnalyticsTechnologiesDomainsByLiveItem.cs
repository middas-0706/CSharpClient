...
namespace DataForSeo.Client.Models
{
    ...
    public class DomainAnalyticsTechnologiesDomainsByLiveItem 
    {
        ...
        /// <br/>to get a full list of technologies and their structure, refer to the <see href="/v3/domain_analytics/technologies/technologies/">technologies endpoint</see>
        /// </summary>
