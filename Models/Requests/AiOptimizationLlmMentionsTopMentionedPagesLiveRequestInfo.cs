...
namespace DataForSeo.Client.Models.Requests
{
    ...
    public class AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo 
    {
        ...
        /// <summary>
        /// array of pages to include in the response
        /// <br/>optional field
        /// <br/>if specified, only the listed pages will be returned in the <c>items</c> array
        /// <br/>example:
        /// <br/><c>'include_pages': ['https://example.page/']</c>
        /// </summary>
        [JsonProperty("include_pages", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        public IEnumerable<string> IncludePages { get; set; }

        /// <summary>
        /// array of pages to exclude from the response
        /// <br/>optional field
        /// <br/>if specified, the listed pages will be omitted from the <c>items</c> array
        /// <br/>example:
        /// <br/><c>'exclude_pages': ['https://example.page/']</c>
        /// </summary>
