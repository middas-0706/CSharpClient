...
namespace DataForSeo.Client.Models.Requests
{
    ...
    public class OnPagePagesRequestInfo 
    {
        ...
        /// <br/>example:
        /// <br/><c>['meta.external_links_count','&lt;=',50]</c><c>['url','like','https://dataforseo.com/apis/dataforseo-labs-api']</c><c>[['checks.high_waiting_time','=',false],'and',['resource_type','=','html']]</c><c>[['page_timing.duration_time','&lt;',100],'and',[['checks.large_page_size','=',false],'or',['checks.high_waiting_time','=',false]]]</c>The full list of possible filters is available <see href="/v3/on_page/filters_and_thresholds/?bash">by this link.</see>
        /// </summary>
