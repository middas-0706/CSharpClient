...
namespace DataForSeo.Client.Models.Requests
{
    ...
    public class KeywordsDataClickstreamDataDataforseoSearchVolumeLiveRequestInfo 
    {
        ...
        /// <br/>you can receive the list of available locations with <c>location_name</c> by making a separate request to <c>https://api.dataforseo.com/v3/keywords_data/clickstream_data/locations_and_languages</c>
        /// <br/>example:
        ...
        /// <br/>if you use this field, you can receive the list of available locations with <c>location_code</c> by making a separate request to the <c>https://api.dataforseo.com/v3/keywords_data/clickstream_data/locations_and_languages</c>
        /// <br/>example:
        /// <br/><c>2826</c>
        /// </summary>
        ...
        /// <br/>you can receive the list of available languages with their <c>language_name</c> by making a separate request to the <c>https://api.dataforseo.com/v3/keywords_data/clickstream_data/locations_and_languages</c>
        /// <br/>example:
        /// <br/><c>English</c>
        /// </summary>
        ...
        /// <br/>you can receive the list of available languages with their <c>language_code</c> by making a separate request to the <c>https://api.dataforseo.com/v3/keywords_data/clickstream_data/locations_and_languages</c>
        /// <br/>example:
        /// <br/><c>en</c>
        /// </summary>
        ...
        /// <br/>optional field
        /// <br/>if set to <c>true</c>, you will get DataForSEO search volume values based on clickstream data;
        /// <br/>if set to <c>false</c>, Bing search volume data will be used to calculate DataForSEO search volume;
        /// <br/>default value: <c>true</c>;
        /// <br/>Note: Bing search volume is available for locations provided in <see href="https://docs.dataforseo.com/v3/keywords_data/bing/search_volume_history/locations_and_languages/?bash">Bing Search Volume History Locations</see> and <see href="https://docs.dataforseo.com/v3/keywords_data/bing/locations/?bash">Bing Ads Locations</see> endpoints; search volume values for any other location are calculated based on clickstream data even if you set this parameter to <c>false</c>
        /// </summary>
