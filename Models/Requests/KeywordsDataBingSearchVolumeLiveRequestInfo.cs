...
namespace DataForSeo.Client.Models.Requests
{
    ...
    public class KeywordsDataBingSearchVolumeLiveRequestInfo 
    {
        ...
        /// <br/>example:
        /// <br/><c>'2020-01-01'</c>Note: we do not recommend using a custom time range for the past year's dates
        /// </summary>
        ...
        /// <br/>date format: <c>'yyyy-mm-dd'</c>
        /// <br/>example:
        /// <br/><c>'2020-03-15'</c>Note: we do not recommend using a custom time range for the past year's dates
        /// </summary>
