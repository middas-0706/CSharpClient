...
namespace DataForSeo.Client.Models.Requests
{
    ...
    public class AiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo 
    {
        ...
        /// <br/>optional field
        /// <br/>if specified, only the listed brands will be returned in the <c>items</c> array
        /// <br/>example:
        /// <br/><c>'include_brands': ['Audi']</c>
        /// </summary>
        [JsonProperty("include_brands", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        public IEnumerable<string> IncludeBrands { get; set; }

        /// <summary>
        /// array of brands to exclude from the response
        /// <br/>optional field
        /// <br/>if specified, the listed brands will be omitted from the <c>items</c> array
        /// <br/>example:
        /// <br/><c>'exclude_brands': ['Audi']</c>
        /// </summary>
        [JsonProperty("exclude_brands", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        public IEnumerable<string> ExcludeBrands { get; set; }
