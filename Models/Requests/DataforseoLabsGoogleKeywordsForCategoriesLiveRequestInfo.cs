...
namespace DataForSeo.Client.Models.Requests
{
    ...
    public class DataforseoLabsGoogleKeywordsForCategoriesLiveRequestInfo 
    {
        ...
        /// <br/>optional field
        /// <br/>if set to <c>true</c>, you will get keywords featured in all specified categories;
        /// <br/>if set to <c>false</c>, you will keywords that are specified in any of the specified categories;
        ...
        /// <br/>example:
        /// <br/><c>['keyword_info.search_volume,desc','keyword_info.competition,asc']</c>
        /// </summary>
