...
namespace DataForSeo.Client.Models.Requests
{
    ...
    public class DataforseoLabsGoogleRelatedKeywordsLiveRequestInfo 
    {
        ...
        /// <br/>optional field
        /// <br/>if <c>true</c>, <c>serp_info</c> and <c>related_keywords</c> will be returned for the main keyword in the group that the specified <c>keyword</c> belongs to;
        /// <br/>if <c>false</c>, <c>serp_info</c> and <c>related_keywords</c> will be returned for the specified <c>keyword</c> (if available);
        /// <br/>refer to <see href="https://dataforseo.com/help-center/replace_with_core_keyword">this help center article</see> for more details;
        /// <br/>default value: <c>false</c>
        /// </summary>
        ...
        /// <br/>example:
        /// <br/><c>['keyword_data.keyword_info.search_volume','&gt;',0]</c>
        /// <br/><c>[['keyword_info.search_volume','in',[0,1000]],'and',['keyword_data.keyword_info.competition_level','=','LOW']]</c>
        /// <br/><c>[['keyword_data.keyword_info.search_volume','&gt;',100],'and',[['keyword_data.keyword_info.cpc',''or',['keyword_info.high_top_of_page_bid','&lt;=',0.5]]]</c>
