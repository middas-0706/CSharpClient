...
namespace DataForSeo.Client.Models.Requests
{
    ...
    public class OnPageRedirectChainsRequestInfo 
    {
        ...
        /// <br/>if you specify the <c>10</c> value, the first ten redirect chains in the results array will be omitted and the data will be provided for the successive redirect chains
        /// </summary>
        ...
        /// <br/><c>is_redirect_loop</c>
        /// <br/>the following operators are supported:
        /// <br/><c>regex</c>, <c>not_regex</c>, <c>=</c>, <c>&lt;&gt;</c>
        /// <br/>examples:
        /// <br/><c>['is_redirect_loop','=','true']</c>
        /// <br/><c>['is_redirect_loop','&lt;&gt;','false']</c>
        /// </summary>
