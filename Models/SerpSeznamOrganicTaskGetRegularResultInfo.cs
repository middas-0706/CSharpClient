...
namespace DataForSeo.Client.Models
{
    ...
    public class SerpSeznamOrganicTaskGetRegularResultInfo 
    {
        ...
        /// <br/><c>images</c>, <c>local_pack</c>, <c>organic</c>, <c>related_searches</c>, <c>top_stories</c>, <c>featured_snippet</c>, <c>video</c>
        /// <br/>note that this array contains all types of search results found in the returned SERP;
        /// <br/>however, this endpoint provides data for the <c>organic</c> type only
        /// <br/>to get all items (inlcuding SERP features and rich snippets) found in the returned SERP, please refer to the <see href="/v3/serp/seznam/organic/task_get/advanced">Seznam Organiс Advanced SERP endpoint</see>
        /// </summary>
