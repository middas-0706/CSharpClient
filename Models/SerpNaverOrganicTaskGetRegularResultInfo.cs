...
namespace DataForSeo.Client.Models
{
    ...
    public class SerpNaverOrganicTaskGetRegularResultInfo 
    {
        ...
        /// <br/><c>images</c>, <c>local_pack</c>, <c>map</c>, <c>organic</c>, <c>paid</c>, <c>related_searches</c>, <c>video</c>
        /// <br/>note that this array contains all types of search results found in the returned SERP;
        /// <br/>however, this endpoint provides data for <c>organic</c> and <c>paid</c> types only
        /// <br/>to get all items (inlcuding SERP features and rich snippets) found in the returned SERP, please refer to the <see href="/v3/serp/naver/organic/task_get/advanced">Naver Organiс Advanced SERP endpoint</see>
        /// </summary>
