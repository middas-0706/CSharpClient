...
namespace DataForSeo.Client.Models
{
    ...
    public class SerpBingOrganicTaskGetAdvancedResultInfo 
    {
        ...
        /// <br/>            <see href="#answer_box">answer_box</see>, <see href="#carousel">carousel</see>, <see href="#events">events</see>, <see href="#featured_snippet">featured_snippet</see>, <see href="#hotels">hotels_pack</see>, <see href="#images">images</see>, <see href="#jobs">jobs</see>, <see href="#local_pack">local_pack</see>, <see href="#map">map</see>, <see href="#organic">organic</see>, <see href="#paid">paid</see>, <see href="#people_also_ask">people_also_ask</see>, <see href="#people_also_search">people_also_search</see>, <see href="#questions_and_answers">questions_and_answers</see>,<see href="#recipes">recipes</see>, <see href="#related_searches">related_searches</see>, <see href="#shopping">shopping</see>, <see href="#top_stories">top_stories</see>, <see href="#video">video</see>, <see href="#ai_overview">ai_overview</see>
        /// </summary>
