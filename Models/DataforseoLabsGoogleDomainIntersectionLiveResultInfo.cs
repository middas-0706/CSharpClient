...
namespace DataForSeo.Client.Models
{
    ...
    public class DataforseoLabsGoogleDomainIntersectionLiveResultInfo 
    {
        ...
        /// </summary>
        [JsonProperty("target1", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        public string Target1 { get; set; }

        /// <summary>
        /// the second target domain in a POST array
        /// </summary>
        [JsonProperty("target2", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
