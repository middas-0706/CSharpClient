...
namespace DataForSeo.Client.Models
{
    ...
    public class DataforseoLabsGooglePageIntersectionLiveItem 
    {
        ...
        /// <summary>
        /// contains data on the SERP elements found for the returned <c>keyword</c>
        /// <br/>data will be provided in separate arrays for each URL you specified in the <c>pages</c> object when setting a task;
