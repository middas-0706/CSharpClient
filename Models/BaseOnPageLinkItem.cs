...
namespace DataForSeo.Client.Models
{
    ...
    [JsonInheritance("anchor", typeof(OnPageAnchorLinkItem))]
    [JsonInheritance("image", typeof(OnPageImageLinkItem))]
    [JsonInheritance("canonical", typeof(OnPageCanonicalLinkItem))]
    [JsonInheritance("alternate", typeof(OnPageAlternateLinkItem))]
    [JsonInheritance("link", typeof(OnPageLinkLinkItem))]
    [JsonInheritance("redirect", typeof(OnPageRedirectLinkItem))]
    [JsonInheritance("meta", typeof(OnPageMetaLinkItem))]
