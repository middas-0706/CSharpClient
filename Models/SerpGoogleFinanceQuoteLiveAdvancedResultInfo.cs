...
namespace DataForSeo.Client.Models
{
    ...
    public class SerpGoogleFinanceQuoteLiveAdvancedResultInfo 
    {
        ...
        /// <br/>possible item types: <see href="#google_finance_hero_groups">google_finance_hero_groups</see>, <see href="#google_finance_quote">google_finance_quote</see>, <see href="#google_finance_compare_to">google_finance_compare_to</see>, <see href="#google_finance_news">google_finance_news</see>, <see href="#google_finance_financial">google_finance_financial</see>, <see href="#google_finance_futures_chain">google_finance_futures_chain</see>, <see href="#google_finance_details">google_finance_details</see>, <see href="#google_finance_about">google_finance_about</see>, <see href="#google_finance_interested">google_finance_interested</see>, <c>google_finance_people_also_search</c>
        /// </summary>
