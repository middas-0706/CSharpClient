...
**BlockRank** | **int?** | <em>block rank in SERP</em><br>            position among all the blocks in SERP |[optional]|
**BlockName** | **string** | <em>name of the block in SERP</em><br>            example:<br>            <code>'People also watched'</code><br> |[optional]|
**ChannelId** | **string** | <em>ID of the channel</em> |[optional]|
**Url** | **string** | <em>URL of the channel</em> |[optional]|