...
**MaxValueIndex** | **int?** | <em>max value among comparable terms</em><br>represents the maximum value if you specified more than two keywords in a POST array<br>if you specified only one keyword, the value will be <code>null</code> |[optional]|