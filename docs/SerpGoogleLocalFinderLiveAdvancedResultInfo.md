...
**ItemTypes** | **IEnumerable<string>** | <em>types of search results in SERP</em><br>contains types of search results (<code>items</code>) found in SERP.<br>possible item types:<br><code>local_pack</code> |[optional]|
...
**Items** | **IEnumerable<LocalPackSerpElementItem>** | <em>items of the element</em> |[optional]|