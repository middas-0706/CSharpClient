...
**Markets** | **IEnumerable<Markets>** | <em>financial markets data</em><br>array of items containing market indexes and other financial information related to these indexes |[optional]|