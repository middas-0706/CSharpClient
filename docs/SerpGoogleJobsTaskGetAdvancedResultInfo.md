...
**ItemTypes** | **IEnumerable<string>** | <em>types of search results in SERP</em><br>contains types of search results (<code>items</code>) found in SERP.<br>possible item types:<br><code>google_jobs_item</code> |[optional]|
...
**Items** | **IEnumerable<GoogleJobsItem>** | <em>items of the element</em> |[optional]|