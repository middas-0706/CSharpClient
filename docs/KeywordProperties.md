...
**IsAnotherLanguage** | **bool?** | <em>detected language of the keyword is different from the set language</em><br>if <code>true</code>, the language set in the request does not match the language determined by our system for a given keyword |[optional]|
