...
**ItemTypes** | **IEnumerable<string>** | <em>types of search results in SERP</em><br>contains types of search results (<code>items</code>) found in SERP.<br>possible item types: <code>organic</code>, <code>paid</code> |[optional]|
...
**Items** | **IEnumerable<BaseBingSerpApiElementItem>** | <em>items inside the element</em><br>array of 8 search queries related to the keyword |[optional]|