...
**ItemTypes** | **IEnumerable<string>** | <em>types of search results found in SERP</em><br>possible item types:<br><code>event_item</code> |[optional]|
...
**Items** | **IEnumerable<EventItem>** | <em>items of the element</em> |[optional]|