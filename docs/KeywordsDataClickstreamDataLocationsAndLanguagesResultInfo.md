...
**LocationCodeParent** | **string** | <em>the code of the superordinate location</em><br>the value will be <code>null</code> as <code>Country</code> is the only supported <code>location_type</code> for this API |[optional]|
