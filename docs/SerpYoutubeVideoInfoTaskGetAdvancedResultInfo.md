...
**ItemTypes** | **IEnumerable<string>** | <em>types of search results in SERP</em><br>            contains types of search results (<code>items</code>) found in SERP.<br>            possible item:<br>            <code>youtube_video_info</code> |[optional]|
**ItemsCount** | **long?** | <em>the number of results returned in the <strong><code>items</code></strong> array</em> |[optional]|
**Items** | **IEnumerable<YoutubeVideoInfo>** | <em>elements of search results found in SERP</em> |[optional]|