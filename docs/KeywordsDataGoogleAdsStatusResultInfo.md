...
**LastYearInMonthlySearches** | **int?** | <em>the latest year for which search volume data is available</em> |[optional]|
**LastMonthInMonthlySearches** | **int?** | <em>the latest month for which search volume data is available</em> |[optional]|