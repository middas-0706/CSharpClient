...
**ItemTypes** | **IEnumerable<string>** | <em>types of search results in SERP</em><br>contains types of search results (<code>items</code>) found in SERP.<br>possible item types:<br><code>carousel</code>, <code>images_search</code>, <code>related_searches</code> |[optional]|
...
**Items** | **IEnumerable<BaseSerpApiGoogleImagesElementItem>** | <em>elements of search results found in SERP</em> |[optional]|