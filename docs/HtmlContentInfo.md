...
**DescriptionToContentConsistency** | **double?** | consistency of the meta description tag with the page contentmeasured from 0 to 1 |[optional]|
**TitleToContentConsistency** | **double?** | consistency of the meta title tag with the page contentmeasured from 0 to 1 |[optional]|
**MetaKeywordsToContentConsistency** | **double?** | consistency of meta keywordstag with the page contentmeasured from 0 to 1 |[optional]|